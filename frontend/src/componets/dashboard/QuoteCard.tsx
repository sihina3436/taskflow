...
const quotes: Quote[] = [
  ...
  { text: "The best time is now.", author: "Unknown" },
  ...
  { text: "Effort defines destiny.", author: "Unknown" },
  { text: "Do something today.", author: "Unknown" },
  { text: "Success requires sacrifice.", author: "Unknown" },
  ...
  { text: "Courage fuels progress.", author: "Unknown" },
  { text: "Commit. Execute. Repeat.", author: "Unknown" }
];
